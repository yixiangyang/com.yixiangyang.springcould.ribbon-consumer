...
public class tt {
	...
	public static void main(String[] args) throws IOException {
		...
		//jsonObject.put("id", "1347");
		jsonObject.put("id", "#");
		jsonObject.put("name", "1dfs");
		jsonObject.put("acreage", "1591.4444444");
		jsonObject.put("business_type", "BG");
        
       // String qrData = "这个是我的ID";//内容信息
		String qrData = jsonObject.toJSONString();
		//String qrData = "https://www.baidu.com/?tn=39042058_27_oem_dg";
        ...
        bufferedImage.flush();
        //设置图片格式，与输出的路径
        ImageIO.write(bufferedImage, "jpg", new File("E:/qrcode4.jpg"));
